  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-2xl mx-auto">
        <p
          className="inline-block font-space-mono text-xs uppercase tracking-[0.35em] text-foreground bg-white/90 rounded-full px-5 py-1.5 mb-6 opacity-0 animate-fade-up-in"
